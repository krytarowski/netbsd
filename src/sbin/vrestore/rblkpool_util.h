 ...
 */
/*
 * @(#)$RCSfile: rblkpool_util.h,v $ $Revision: 1.1.2.2 $ (DEC) $Date: 1993/09/08 16:04:27 $
 */
...
static char    *
                rcsid_rblkpool_util = "rblkpool_util.h - $Date: 1993/09/08 16:04:27 $";
